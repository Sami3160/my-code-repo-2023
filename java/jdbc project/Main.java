...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            String marksheet_name; // variable to store the name of marksheet on which CRUD functions are to be
                                   // done
            System.out.println(
    ...
    /*
     * dashboard function is the dashboard where users get to choose to do show,
    ...
    public static void dashboard(Connection conn, String marksheet_name) {
        ...
        String formatedMarksheetName = String.format("%-8s", marksheet_name);
        System.out.println("\n\n+-----------------------------------------------+");
        System.out.println("| Welcome to the School Dashboard of [" + formatedMarksheetName + "] |");
        System.out.println("+-----------------------------------------------+");

        System.out.println("\nEnter the choice");
        System.out.println(
                "1. Show available Marksheets\n2. Create New Marksheet\n3. Delete marksheet\n\n4. Add Student Details\n5. Display Marksheet\n6. Edit Student Details \n7. Delete student Details\n\n8. Quit program\n");
        System.out.print(">>");
    ...
    /*
     * deleteStudent function is used to delete a student details on basis of their
     * rollno
     */
    public static void deleteStudent(Connection conn, String marksheet_name) {
        try {
            ...
            String query = "DELETE FROM " + marksheet_name + " WHERE Rollno=?"; // sql query to delete a student row of
                                                                                // particular rollno
    ...
    /*
     * editMarkSheet function is used to edit the marks and name of the student by
     * entering their rollno
     */
    public static void editMarkSheet(Connection conn, String marksheet_name) {
        try {
            String query = "UPDATE " + marksheet_name
                    + " SET Name=?, Physics=?, Maths=?, Chemistry=?, Biology=? WHERE Rollno=?";
    ...
    /*
     * showClasses function displays all the marksheets that are available in the
     * school
     */
    ...
    /*
     * createNewClass is used to create a new class or a new marksheet for the
     * school
     */
    public static void createNewClass(Connection conn) {
        try {
            ...
            String query = "CREATE TABLE " + name_of_class
                    + " (Rollno int primary key auto_increment, Name varchar(35), Physics int, Maths int, Chemistry int, Biology int)";
    ...
    public static void addStudentDetails(Connection conn, String marksheet_name) {
        try {
            String query = " INSERT INTO " + marksheet_name
                    + " (Name,Physics,Maths,Chemistry,Biology) VALUES(?,?,?,?,?)";
            ...
            while (no_of_students > 0) {
                ...
                System.out.println("[" + ((no_of_students % no_of_students) + 1) + "]Enter student name: ");
    ...
    /*
     * displayTable will display the marksheet containing rollno, name and subject
     * marks
     */
    public static void displayTable(Connection conn, String marksheet_name) {
        try {
            ...
            while (set.next()) {
                ...
                System.out.println("|" + formattedId + "|" + formattedName + "|" + formattedPhysics + "|"
                        + formattedChemistry + "|" + formattedMaths
                        + "|" + formattedBiology + "|");
            }
    ...
    public static Connection connectDb() {
        try {
            ...
            String password = "root"; // password of db taken from environment variable MYSQL_PASSKEY, replace string
